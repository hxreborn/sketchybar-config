#!/bin/bash
# Dynamic icon map override - separates Ghostty from other terminals
# This file takes precedence over icon_map.sh

__icon_map() {
  case $1 in
  "Ghostty")
    # Custom Ghostty icon using the new glyph
    icon_result=":ghostty:"
    ;;
  "Brave Browser")
  ...
  "Podcasts")
    ...
    ;;
  # NOTE: Ghostty removed from this list - it has its own icon above
